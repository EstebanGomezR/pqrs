...
<html lang="en">
    ...
    <div class="container">
        ...
        <!--Inicio del formulario de Menu-->
         <form method="POST" action="contraseña_prof.php">
                <div class="row">
                            ...
                            <center>
                                ...
                                <br><br><br>
                                      <p>Contraseña Antigua:</p>
                                        ...
                                        <br/>  <br/>  <br/>
                                        <p><input type="submit" class="btn btn-success" value="Aceptar" name="btn_index">
                                        <p><input type="submit" onclick="action='interfaz_prof.php'" class="btn btn btn-danger" value="Cancelar" name="btn_index">
                                        <hr/>
